    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <Image width={2} height={2} src="https://flowbite.com/docs/images/logo.svg" className="h-8" alt="Flowbite Logo" />
        ...
        <div className="flex md:order-2">
          ...
          <div className={`relative hidden md:block ${isSearchOpen ? 'w-full' : ''}`}>
        ...
        <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${isSearchOpen ? 'flex flex-col' : 'hidden md:flex'}`} id="navbar-search">
          <input
            type="text"
            id="search-navbar"
